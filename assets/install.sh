...
############
# Support for smarthost / mail relay
############
if [ -n "${mailrelay+1}" ]; then
  postconf -e relayhost=$mailrelay
  postconf -e mynetworks=192.168.0.0/16,127.0.0.0/8,10.0.0.0/8
  postconf -e smptd_recipient_restrictions=permit_mynetworks
else
